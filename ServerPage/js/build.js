(function () {
    ...
    }, {"./analyzer": 1, "./grid": 2, "./maze": 5, "./solver": 6, "./stats": 7, "underscore": 9}],
    ...
    6: [function (require, module, exports) {
        ...
        function Solver(maze) {
            ...
            _.defaults(this, {  // 填充undefined属性, 如果属性被定义, 则default无效
                'explore': 0.4,  //  探索系数，随机选择动作，而不根据策略
                'alpha': 0.5,  //
                'gamma': 0.9,
                'eta': 0.1,  // 学习率
         ...
         */
            ...
            updateTheta: function () {
                ...
                let STEPS = this.path.length < totalNodes * 10 ? this.path.length : -1;
    ...
    }, {"./analyzer.js": 1, "./helpers": 3, "underscore": 9}],
    7: [function (require, module, exports) {
        ...
        Stats.prototype = {
            ...
            visualizePolicy: function () {
                ...
                var high = _.max(values, function (node) {
                    return node['value'];
                })['value'];
                var low = _.min(values, function (node) {
                    return node['value'];
                })['value'];
