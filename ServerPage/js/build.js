...
},{"./helpers":3,"underscore":9}],3:[function(require,module,exports){
...
},{"./analyzer":1,"./grid":2,"./maze":5,"./solver":6,"./stats":7,"underscore":9}],5:[function(require,module,exports){
...
},{"./helpers":3,"underscore":9}],6:[function(require,module,exports){
var _ = require('underscore');
var helpers = require('./helpers');
...
Solver.prototype = {
    ...
    completedMaze: function () {
        ...
        // if (this.changeRate(this.policy, oldPolicy) && this.runs > 10) {
    ...
    updateTheta: function() {
        ...
        for(let s in this.s_a_log) {
            for (let a in this.s_a_log[s]) {
                let delta_theta = (this.s_a_log[s][a] - this.policy[s][a] * sum_s_times[s]) / this.path.length;
...
},{"./analyzer.js":1,"./helpers":3,"underscore":9}],7:[function(require,module,exports){
var _ = require('underscore');
var helpers = require('./helpers');
...
Stats.prototype = {
    setupCanvas: function() {
        ...
        let grid = this.solver.maze.grid;
    ...
    drawDot: function(node) {
        ...
        this.ctx.fillStyle = 'rgba(250, 10, 10, ' + val + ')';  // 以颜色透明度表示policy大小
...
},{"./helpers":3,"underscore":9}],8:[function(require,module,exports){
/*!
 * Chart.js v3.7.0
